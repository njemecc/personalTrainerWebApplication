...
<html lang="en">
  ...
  <body>
    <header class="trening-header">
      <nav>
        <div class="logo">
          <img class="logo-slika" src="images/logoo.jpeg" />
        </div>
    ...
    <!-- OVO JE POCETAK KONTEJNERA KONTEJNERCINE 1-->
    <!-- <video src="vezbe/IME_VEZBE_KOJU_ZELIS_DA_POSTAVIS"-->
    <!--IZMEDJU <p>  </p> tagova napises koliko ponavljanja primeer:5x12-->
    <div class="container-containera kontejnercina">
      <div class="trening-container">
        <div class="container-containera hatri">
          <h3 class="flex-grow">PUSH DAY</h3>
    ...
    <!-- OVO JE KRAJ KONTEJNERA KONTEJNERCINE 1-->

    <!-- OVO JE POCETAK KONTEJNERA KONTEJNERCINE 2 -->
    ...
    <!-- OVO JE Kraj KONTEJNERA KONTEJNERCINE 2-->

    <!-- OVO JE POCETAK KONTEJNERA KONTEJNERCINE 3-->
    ...
    <!-- OVO JE KRAJ KONTEJNERA KONTEJNERCINE 3 -->

    <!-- OVO JE POCETAK KONTEJNERA KONTEJNERCINE 4-->
    ...
    <!-- OVO JE KRAJ KONTEJNERA KONTEJNERCINE 4-->

    <!-- OVO JE POCETAK KONTEJNERA KONTEJNERCINE 5-->
    <div class="container-containera kontejnercina">
      <div class="trening-container">
        <div class="container-containera hatri">
    ...
    <!-- OVO JE KRAJ KONTEJNERA KONTEJNERCINE 5-->

    <!-- OVO JE POCETAK KONTEJNERA KONTEJNERCINE 6-->
    ...
    <!-- OVO JE KRAJ KONTEJNERA KONTEJNERCINE 6-->

    <!-- OVO JE POCETAK KONTEJNERA KONTEJNERCINE 7-->
    ...
    <!-- OVO JE KRAJ KONTEJNERA KONTEJNERCINE 7 !-->
